...
```{r, echo=F,out.width="100%"}
  ...
  ggplot(cit[cit$year < 2024,],aes(x=year,y=cites))+
    ...
    ylab('Google Scholar\n Citations')+
    annotate('text',label=format(Sys.time(), "%Y-%m-%d %H:%M:%S %Z"),x=-Inf,y=Inf,vjust=1.5,hjust=-0.05,size=4,colour='gray')+
    annotate('text',label=paste("Average Cites per Year: ",round(mean(cit$cites),1),sep=""),x=-Inf,y=mean(cit$cites)+0.5,hjust=-0.05,size=4,colour='black',alpha=.8)
